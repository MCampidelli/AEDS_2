...
public class avl {
     private static void arqLog(String matricula, double tempo, long comp) {
          try (FileWriter arq = new FileWriter(matricula + "_arvore_avl.txt")) {
     ...
     public static void main(String[] args) throws Exception {
          ...
          while (nomeRest.compareTo("FIM") != 0) {
               if (arv.pesquisar(nomeRest)) System.out.print("SIM");
...
class Arvore {
     ...
     private boolean pesquisar (String nome, No i) {
          ...
          if (i != null) {
               this.comp++;
               if (nome.compareTo(i.restaurante.getNome()) == 0) resp = true;
     ...
     private void caminhaCentral (No i) {
          if (i != null) {
