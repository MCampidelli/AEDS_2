...
// Questão 05 ----- Pesquisa Sequencial em Java
...
public class Sequencial {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!(nome = sc.nextLine()).equals("FIM")) {
            ...
            boolean achou = buscaSequencial(base, n, nome);
        ...
        fw.write("123456\t" + comparacoes + "\t" + tempo);
        fw.close();

        sc.close();
    }

    public static boolean buscaSequencial(Restaurante[] base, int n, String nome) {

        for (int i = 0; i < n; i++) {
            comparacoes++;
            if (base[i].getNome().compareTo(nome) == 0) {
                return true;
            }
        }
        return false;
